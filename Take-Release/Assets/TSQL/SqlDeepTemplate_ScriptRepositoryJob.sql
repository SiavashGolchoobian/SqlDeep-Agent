...
[string]$myConnectionString = "Data Source= $(ESCAPE_SQUOTE(MACH)).sqldeep.local\$(ESCAPE_SQUOTE(INST)),49149;Integrated Security=True;Initial Catalog=SqlDeep;Encrypt=yes"
