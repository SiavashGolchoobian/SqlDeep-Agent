...
$myFileList['SqlDeepDeleteOldBackup.psm1']= [PSCustomObject]@{ItemType='OTHER';Tags='TSX';ItemName='';FilePath=$SqlDeepPSModulesPath;ItemVersion='1.0';Description='SqlDeep Delete Old Backup files Powershell Module'}
